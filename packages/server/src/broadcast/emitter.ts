...
export type LiveEvent =
  ...
  | { type: 'lap_completed'; data: { sessionId: number; driverName: string; lapTimeMs: number; lapNumber: number; cuts: number; valid: boolean; carModel: string; split1Ms: number | null; split2Ms: number | null } }
