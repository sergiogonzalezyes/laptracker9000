...
export default function SessionList() {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { style: { display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap', alignItems: 'center' }, children: [_jsx("input", { placeholder: "Filter by track...", value: trackFilter, onChange: e => { setTrackFilter(e.target.value); setPage(0); }, style: { minWidth: 180 } }), _jsx("div", { style: { display: 'flex', gap: 2 }, children: [['', 'ALL'], ['PRACTICE', 'PRACTICE'], ['QUALIFY', 'QUALIFY'], ['RACE', 'RACE']].map(([val, label]) => (_jsx("button", { onClick: () => { setTypeFilter(val); setPage(0); }, style: {
