...
export default function DriverCard({ driver, rank, leaderBestMs, lapHistory = [] }) {
    ...
    return (_jsxs("div", { style: {
            ...
            cursor: 'pointer',
                ...
                }, children: hasTime ? formatLapTime(driver.bestLapMs) : '--:--.---' }), !isLeader && hasTime && (_jsxs("div", { style: { fontFamily: 'var(--font-mono)', fontSize: 12, color: 'var(--text-muted)' }, children: ["+", formatLapTime(gap)] })), isLeader && (_jsx("div", { style: { fontSize: 11, fontWeight: 600, color: 'var(--accent)', letterSpacing: '0.06em' }, children: "LEADER" })), _jsxs("div", { style: { marginTop: 10, paddingTop: 8, borderTop: '1px solid var(--border)' }, children: [lapHistory.length >= 3 && (_jsx("div", { style: { marginBottom: 6 }, children: _jsx(Sparkline, { times: lapHistory, width: 180, height: 28, color: isLeader ? 'var(--accent)' : '#555' }) })), _jsx("div", { style: { fontSize: 11, color: 'var(--text-muted)' }, children: driver.carModel.replace(/_/g, ' ') })] })] }));
}
