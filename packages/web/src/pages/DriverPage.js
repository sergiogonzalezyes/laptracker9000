...
export default function DriverPage() {
    ...
    return (_jsxs("div", { style: { flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', gap: 14, overflow: 'hidden' }, children: [_jsxs("div", { style: {
                    flexShrink: 0,
